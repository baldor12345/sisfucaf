...
<div class="form-row">
    ...
    <div class="form-group col-md-4 col-sm-4" style="margin-left: 12.5px;">
		{!! Form::label('edad', 'Edad:', array('class' => '')) !!}
		{!! Form::number('edad', null, array('class' => 'form-control input-xs', 'id' => 'edad', 'placeholder' => '')) !!}
    </div>
	<div class="form-group col-md-4 col-sm-4" style="margin-left: 12.5px;">
...
<div class="form-row">
    <div class="form-group col-md-4 col-sm-4">
		...
		{!! Form::text('telefono_fijo', null, array('class' => 'form-control input-xs', 'id' => 'telefono_fijo', 'placeholder' => 'Ingrese telefono fijo')) !!}
    </div>
    <div class="form-group col-md-4 col-sm-4" style="margin-left: 12.5px;">
		{!! Form::label('telefono_movil1', 'Telefono movil 1:', array('class' => '')) !!}
		{!! Form::text('telefono_movil1', null, array('class' => 'form-control input-xs', 'id' => 'telefono_movil1', 'placeholder' => 'Ingrese telefono movil')) !!}
    </div>
	<div class="form-group col-md-4 col-sm-4" style="margin-left: 12.5px;">
		{!! Form::label('telefono_movil2', 'Telefono movil 2:', array('class' => '')) !!}
		{!! Form::text('telefono_movil2', null, array('class' => 'form-control input-xs', 'id' => 'telefono_movil2', 'placeholder' => 'Ingrese telefono movil')) !!}
    </div>
</div>
